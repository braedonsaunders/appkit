---
'@braedonsaunders/appkit-viewspec': minor
---

A closed, declarative page-composition language, so a page can be data an application stores rather than code it ships.
