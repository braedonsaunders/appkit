...
// consumer typing a variable that holds one had to reach past @braedonsaunders/tenant
// into @braedonsaunders/db for a type it only ever sees through this API.
export type { RoleScope } from '@braedonsaunders/db'
export {
  type TenantDatabase,
