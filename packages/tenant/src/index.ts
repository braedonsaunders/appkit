...
// consumer typing a variable that holds one had to reach past @braedonsaunders/appkit-tenant
// into @braedonsaunders/appkit-db for a type it only ever sees through this API.
export type { RoleScope } from '@braedonsaunders/appkit-db'
export {
  type TenantDatabase,
