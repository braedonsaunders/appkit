...
export const SQL_DESTINATION_SUMMARY = { key: 'sql', name: 'External SQL database', description: 'Insert mapped rows into PostgreSQL, MySQL, MariaDB, or SQL Server over a verified TLS connection.', iconKey: 'database', mappingKind: 'sql', reversible: true } as const satisfies DestinationSummary
