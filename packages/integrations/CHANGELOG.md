...
- 1319bfb: Record in-memory integration status, surface status persistence failures, and
  report database cleanup failures instead of silently discarding them.
