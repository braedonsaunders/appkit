...
export const recipientTargetSchema = emailTargetSchema
...
export function scheduledSafeActions(_hasRecordSelect = false): Set<ActionKind> {
  return new Set(WORKER_TRIGGER_ACTIONS)
}
