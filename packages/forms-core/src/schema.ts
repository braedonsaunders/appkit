...
export const fieldTypeSchema = z.enum([
  ...
  'gl_account', // accounting chart-of-accounts picker
  'party', // vendor / customer / employee picker
  // media
  'photo',
...
export type ChoiceOption = { value: string; label: I18nString }
...
type SchemaInvariantIssue = SchemaIssue
...
export const CHOICE_FIELD_TYPES = new Set<FieldType>([
  'select',
  'radio',
  'multi_select',
  'checkbox_group',
...
export function parseFormSchema(input: unknown): ParseFormSchemaResult {
  const result = formSchemaV1.safeParse(input)
...
export function emptyFormSchema(title: I18nString = 'Untitled form'): FormSchemaV1 {
  return {
    schemaVersion: 1,
    title,
