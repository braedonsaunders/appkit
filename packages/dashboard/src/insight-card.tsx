import { resolveConditionalStyle, type AnalyticResult, type ConditionalRule, type QueryResult, type VisualizationKey, type VisualizationSettings } from '@appkitjs/analytics'
