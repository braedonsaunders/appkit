...
import { authAccounts, authSessions, memberships, tenants, users } from '@braedonsaunders/appkit-db'
...
/** Postgres persistence adapter over the @braedonsaunders/appkit-db identity schema. */
