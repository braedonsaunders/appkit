# @braedonsaunders/telephony

## 0.2.0

### Minor Changes

- 102851e: Add `@braedonsaunders/telephony`: carrier phone-number provisioning over `fetch`, with a
  ...
  Twilio is the first carrier; the catalogue follows the `@braedonsaunders/sms` provider
