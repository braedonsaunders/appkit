...
- Add contextual compact sealers for existing tenant-keyed ciphertext formats:
  caller-supplied HKDF salt, authenticated record context, binary/base64 key
  sources, and a versioned single-string payload.
