import { runEndpoint, type EndpointRequest, type HostAdapters } from '@braedonsaunders/appkit-endpoints'

/**
 * Source-shaped application backend runtime entry. The implementation lives in
 * @braedonsaunders/appkit-endpoints so standalone programmable endpoints and installed apps use
 * one governed QuickJS kernel.
 */
export { runEndpoint as runAppEndpoint, DEFAULT_COSTS as APP_ENDPOINT_DEFAULT_COSTS } from '@braedonsaunders/appkit-endpoints'
export type {
...
} from '@braedonsaunders/appkit-endpoints'
