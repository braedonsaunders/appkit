...
- 8cff487: Compose: `ComposePart.letterhead.reserveSpace`.
...
- dbf95c7: Compose: let the caller choose a part's scale, and centre scaled content.
...
- 9259cc8: Compose: normalise an assembled book to ONE scale, and reserve the footer band.
