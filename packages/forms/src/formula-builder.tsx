...
import { Button, Input, Label, Select } from '@braedonsaunders/appkit-ui'
import {
  ENTITY_ATTRS,
  evaluateFormulaTree,
  type EntityKind,
...
export function FormulaBuilder({
  ...
  return (
    <div className="space-y-3">
      ...
      <details className="rounded-md border border-border bg-bg-subtle/50 p-2 text-xs">
                ...
                <div className="space-y-2">
                  ...
                  <GeneratedValue
                    value={repeatingSections.map((sec) => {
                      ...
                      return (
                        <div key={sec.id} className="rounded border border-border bg-white p-2">
                          ...
                          <GeneratedValue
                            value={Array.from({ length: rowCount }, (_, i) => (
                              <div
                                key={i}
                                className="mt-1 grid grid-cols-2 gap-1 border-t border-border-subtle pt-1"
                              >
                                <GeneratedValue
    ...
    <div className="space-y-1.5">
      ...
      <GeneratedValue
        value={items.map((it, i) => (
          <div key={i} className="rounded border border-border-subtle bg-bg-subtle p-1">
            <Node
              value={it}
              allFields={allFields}
              repeatingSections={repeatingSections}
