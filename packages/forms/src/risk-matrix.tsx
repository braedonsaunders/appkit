...
import { GeneratedText, GeneratedValue, useGeneratedValueTranslations } from './generated-copy'
...
function NotRated({ prefix }: { prefix?: string }) {
  return (
    <span className="inline-flex items-center gap-1 rounded-full bg-surface-muted px-2 py-0.5 text-[11px] font-medium text-fg-muted ring-1 ring-border ring-inset">
...
function RiskChip({
  ...
  return (
    <span className="inline-flex items-center gap-1.5 rounded-full bg-surface-muted px-2 py-0.5 text-[11px] font-medium text-fg-muted ring-1 ring-border ring-inset">
      <span
        aria-hidden
...
export function RiskScoreChip({ score, prefix }: { score: number | null; prefix?: string }) {
  ...
  return (
    <RiskChip
      color={cell?.color ?? hexColor('fg-subtle')}
      score={score}
        ...
        <GeneratedValue
          value={sev.map((label, i) => (
            <div
              ...
              className="truncate px-1 pb-0.5 text-[10px] font-medium text-fg-muted"
            >
          ...
          value={rows.map((li) => (
            <Fragment key={`row-${li}`}>
              <div
                ...
                className="flex items-center justify-end pr-1.5 text-[10px] font-medium text-fg-muted"
              >
                  ...
                  return (
                    <button
                      ...
                      className={cn(
                        ...
                        isSelected && 'font-bold ring-2 ring-fg ring-inset',
  ...
  return (
    <fieldset className="space-y-1.5" disabled={disabled}>
      <div className="flex items-center justify-between gap-2">
        <legend className="text-xs font-medium tracking-wide text-fg-muted uppercase">
