...
// @braedonsaunders/appkit-ai: consumers pass their tenant-resolved AiConfig (provider kind +
...
/** Structurally identical to @braedonsaunders/appkit-ai's AiConfig — pass it straight in. */
...
/** Provider kinds (as named by @braedonsaunders/appkit-ai) that can generate images. */
