...
- `@braedonsaunders/appkit-agent-tools/image-manifest` — a pure emitter that turns a set of
...
shelf, sandboxed execution via `@braedonsaunders/appkit-process-sandbox`, and the in-memory
and Drizzle stores.
