...
export const PACKAGE_CATEGORIES: readonly {
  ...
  },
  {
    ...
    names: [
      '@appkitjs/analytics', '@appkitjs/dashboard', '@appkitjs/customization', '@appkitjs/forms-core',
      '@appkitjs/forms', '@appkitjs/forms-documents', '@appkitjs/forms-pdf', '@appkitjs/reports',
      '@appkitjs/office', '@appkitjs/pdf', '@appkitjs/design-studio', '@appkitjs/scheduling',
    ],
  },
  {
    key: 'platform',
    ...
    names: [
      '@appkitjs/db', '@appkitjs/tenant', '@appkitjs/auth', '@appkitjs/iam', '@appkitjs/superadmin', '@appkitjs/api',
      '@appkitjs/events', '@appkitjs/jobs', '@appkitjs/notifications', '@appkitjs/storage',
      '@appkitjs/crypto', '@appkitjs/oauth', '@appkitjs/process-sandbox', '@appkitjs/desk', '@appkitjs/egress-proxy',
      '@appkitjs/email-render', '@appkitjs/email-designer',
      '@appkitjs/emails', '@appkitjs/mailbox', '@appkitjs/sms', '@appkitjs/telephony', '@appkitjs/voice',
    ],
  },
  {
    key: 'extensions',
    ...
    names: [
      '@appkitjs/ai', '@appkitjs/agent-tools', '@appkitjs/mcp', '@appkitjs/sandbox', '@appkitjs/endpoints', '@appkitjs/scripts', '@appkitjs/apps',
      '@appkitjs/workflows', '@appkitjs/integrations', '@appkitjs/sync',
    ],
  },
]
...
const DEMO_ROUTES: Record<string, string> = {
  ...
  '@appkitjs/tokens': '/components',
  '@appkitjs/ui': '/components',
  '@appkitjs/i18n': '/components',
  '@appkitjs/editor': '/forms',
  '@appkitjs/avatars': '/avatars',
  '@appkitjs/scene': '/packages/scene/demo',
  '@appkitjs/analytics': '/insights',
  '@appkitjs/dashboard': '/dashboard',
  '@appkitjs/customization': '/customization',
  '@appkitjs/forms-core': '/forms/core',
  '@appkitjs/forms': '/forms',
  '@appkitjs/forms-documents': '/forms',
  '@appkitjs/forms-pdf': '/forms',
  '@appkitjs/reports': '/reports',
  '@appkitjs/office': '/packages/office/demo',
  '@appkitjs/pdf': '/reports',
  '@appkitjs/design-studio': '/design-studio',
  '@appkitjs/scheduling': '/scheduling',
  '@appkitjs/db': '/dashboard/platform',
  '@appkitjs/tenant': '/dashboard/platform',
  '@appkitjs/auth': '/admin/users',
  '@appkitjs/iam': '/admin/roles',
  '@appkitjs/superadmin': '/packages/superadmin/demo',
  '@appkitjs/api': '/api-docs',
  '@appkitjs/events': '/admin/audit',
  '@appkitjs/jobs': '/packages/jobs/demo',
  '@appkitjs/notifications': '/notifications',
  '@appkitjs/storage': '/attachments',
  '@appkitjs/crypto': '/packages/crypto/demo',
  '@appkitjs/oauth': '/dashboard/platform',
  '@appkitjs/agent-tools': '/packages/agent-tools/demo',
  '@appkitjs/mcp': '/api-docs',
  '@appkitjs/process-sandbox': '/packages/process-sandbox/demo',
  '@appkitjs/desk': '/packages/desk/demo',
  '@appkitjs/egress-proxy': '/packages/egress-proxy/demo',
  '@appkitjs/email-render': '/packages/email-render/demo',
  '@appkitjs/email-designer': '/email-designer',
  '@appkitjs/emails': '/packages/emails/demo',
  '@appkitjs/mailbox': '/packages/mailbox/demo',
  '@appkitjs/sms': '/packages/sms/demo',
  '@appkitjs/telephony': '/packages/telephony/demo',
  '@appkitjs/voice': '/packages/voice/demo',
  '@appkitjs/ai': '/dashboard/platform',
  '@appkitjs/sandbox': '/admin/scripts',
  '@appkitjs/endpoints': '/api-docs',
  '@appkitjs/apps': '/admin/apps',
  '@appkitjs/scripts': '/admin/scripts',
  '@appkitjs/workflows': '/workflows',
  '@appkitjs/integrations': '/admin/integrations',
  '@appkitjs/sync': '/admin/integrations',
}
...
export const PACKAGE_CATALOG: readonly PackageCatalogItem[] = MANIFESTS.map((manifest) => {
  ...
  return {
    name: manifest.name,
    slug: manifest.name.replace(/^@appkitjs\//, ''),
