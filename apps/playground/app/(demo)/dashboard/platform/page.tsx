...
import { EMAIL_PROVIDER_SPECS } from '@appkitjs/emails/providers'
import { SMS_PROVIDER_SPECS } from '@appkitjs/sms/providers'
import { AdminHub, Badge, Button, type AdminHubGroup } from '@appkitjs/ui'
...
const GROUPS: AdminHubGroup[] = [
  ...
  },
  {
    ...
    cards: [
      ...
      {
        title: '@appkitjs/forms-documents',
    ...
    cards: [
      {
        ...
        icon: <ServerCog />,
        features: [
          'Email, notifications, push, PDF/document, reports, schedules, outbound events, scripts, sandboxes, migrations, and capture',
          'Production payload ceilings, private fan-out, deterministic IDs, retry/backoff, retention, and worker concurrency',
          'Exact repeatable-schedule reconciliation plus lazy, import-safe producer and worker factories',
        ],
        href: '/packages/jobs',
        linkLabel: 'Explore background jobs',
      },
      {
        title: '@appkitjs/storage',
