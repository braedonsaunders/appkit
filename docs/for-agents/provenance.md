...
| `@appkit/notifications` | substantial generalized extraction | Inbox/preferences, category and quiet-hour policy, React UI, Drizzle storage, digest aggregation, push subscription lifecycle, deterministic delivery keys, and channel dispatch policy are present. Provider transports remain optional injected adapters. |
